...
#ifdef _TG_WINDOWS_
class __declspec(dllexport)  DSEmulatorClass : public SEEmulatorBase_ns::SEEmulatorBaseClass
#else
class DSEmulatorClass : public SEEmulatorBase_ns::SEEmulatorBaseClass
#endif
{
