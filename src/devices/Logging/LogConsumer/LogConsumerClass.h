...
//	Command SetFilterLogLevel class definition
class SetFilterLogLevelClass : public Tango::Command
{
public:
	SetFilterLogLevelClass(const char   *name,
	               Tango::CmdArgType in,
				   Tango::CmdArgType out,
				   const char        *in_desc,
				   const char        *out_desc,
	...
	SetFilterLogLevelClass(const char   *name,
				   ...
				   Tango::CmdArgType out)
	:Command(name,in,out)	{};
	~SetFilterLogLevelClass() {};
	
	virtual CORBA::Any *execute (Tango::DeviceImpl *dev, const CORBA::Any &any);
	virtual bool is_allowed (Tango::DeviceImpl *dev, const CORBA::Any &any)
	{return (static_cast<LogConsumer *>(dev))->is_SetFilterLogLevel_allowed(any);}
};
