 ...
 */
//--------------------------------------------------------
DSEmulatorClass::DSEmulatorClass(string &s):SEEmulatorBase_ns::SEEmulatorBaseClass(s)
{
...
void DSEmulatorClass::write_class_property()
{
	...
	str_desc.push_back("Emulator for DS sub-element");
	description << str_desc;
	data.push_back(description);

	//	put cvs or svn location
	string	filename("DSEmulator");
	filename += "Class.cpp";
